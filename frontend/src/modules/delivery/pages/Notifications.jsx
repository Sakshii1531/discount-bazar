...
const Notifications = () => {
  ...
  useEffect(() => {
    ...
    const unsubWithdrawn = onDeliveryBroadcastWithdrawn(getToken, (payload) => {
    ...
    const unsubNew = onNotificationNew(getToken, () => {
      fetchNotifications();
    });
    return () => {
      unsubWithdrawn?.();
              ...
              {notifications.map((notification) => {
                ...
                return (
                  <motion.div
                    ...
                    layout
                    onClick={() => !notification.isRead && handleMarkAsRead(notifId)}>
                    <Card

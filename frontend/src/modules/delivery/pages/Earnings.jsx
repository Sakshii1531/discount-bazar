          ...
          <div className="bg-gradient-to-br from-primary to-brand-600 rounded-2xl p-6 text-white shadow-lg shadow-primary/30 relative overflow-hidden">
            ...
            <div className="flex items-baseline mb-6 relative z-10">
              ...
              <span className="text-5xl font-extrabold tracking-tight">
                {formatAmount(earningsData.totalEarnings)}
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/20 relative z-10">
              <div>
                ...
                <p className="font-bold text-lg">+{"\u20B9"}{formatAmount(earningsData.incentives)}</p>
              </div>
              <div>
                <p className="text-brand-100 text-xs mb-1">Bonuses</p>
                <p className="font-bold text-lg">+{"\u20B9"}{formatAmount(earningsData.bonuses)}</p>
              </div>
            </div>
          </div>
        </motion.div>
                ...
                <div
                  ...
                  <div className="flex items-center">
                    <div
                      ...
                      {isReturnPickup ? <RotateCcw size={16} /> : <ArrowUpRight size={16} />}
                    </div>
                    <div>
                      <p className="font-bold text-gray-900">{isReturnPickup ? "Return Pickup" : txn.type}</p>
                      <p className="text-xs text-gray-500">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-gray-900">{txn.type.includes('Withdrawal') ? '-' : '+'}{"\u20B9"}{formatAmount(txn.amount)}</p>
                    <p

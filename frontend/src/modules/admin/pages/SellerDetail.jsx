...
const SellerDetail = () => {
    ...
    const handleExportOrders = () => {
        ...
        exportToCSV(formatted, `Seller_${(seller?.shopName || 'Orders').replace(/\s+/g, '_')}`);
        showToast('Seller orders exported successfully', 'success');
    };
                                ...
                                <div className="p-4 pb-4 flex items-center justify-between border-b border-slate-50">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <button
                                            ...
                                            title="Export Orders"
                                            className="p-2 bg-slate-50 rounded-xl text-slate-400 hover:text-primary transition-colors active:scale-95"
                                        >

...
const CustomerDetail = () => {
    ...
    const handleExportCSV = () => {
        ...
        const formatted = safeOrders.map(o => ({
            "Order ID": o.id || '',
        ...
        exportToCSV(formatted, `Customer_${(customer?.name || 'Orders').replace(/\s+/g, '_')}`);
        showToast('Customer orders exported successfully', 'success');
    };

        ...
        try {
            ...
            if (targetedUsers > 0) {
                if (delivered === targetedUsers) {
                    successMsg = `Notification broadcast successfully to ${delivered} ${delivered === 1 ? 'user' : 'users'}!`;
                } else {
                    successMsg = `Notification broadcast successfully! Delivered to ${delivered} of ${targetedUsers} targeted users.`;
                }
            }

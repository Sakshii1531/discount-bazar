        ...
        <AnimatePresence>
          {isWebcamOpen && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 z-[1000] bg-black/95 flex flex-col items-center justify-between p-4"
            >
              {/* Top Controls */}
              ...
              <div className="relative w-full max-w-md aspect-[3/4] rounded-3xl overflow-hidden bg-black flex items-center justify-center shadow-2xl border border-white/15 my-auto">
                <video
                  ref={videoRef}
                  autoPlay
                  playsInline
              ...
              {/* Shutter Button */}
              <div className="w-full flex items-center justify-center pb-8 z-10">
                <button
                  type="button"
                  onClick={captureWebcamPhoto}
                  className="h-20 w-20 rounded-full bg-white p-1 flex items-center justify-center shadow-2xl active:scale-95 transition-transform cursor-pointer"
                  aria-label="Capture photo"
                >
                  <div className="h-16 w-16 rounded-full border-4 border-slate-900 bg-white" />
                </button>
              </div>
            </motion.div>
          )}
          ...
          {showAttachmentMenu && (
            <>
              ...
              <motion.div
                ...
                className="absolute bottom-full left-12 mb-3 w-52 bg-white rounded-2xl shadow-2xl border border-slate-100 z-50 overflow-hidden p-1.5 space-y-1"
              >
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="w-full flex items-center gap-3 px-3.5 py-3 rounded-xl text-sm font-bold text-slate-800 hover:bg-slate-50 active:bg-slate-100 transition-colors cursor-pointer"
                >

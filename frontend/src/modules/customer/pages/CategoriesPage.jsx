...
const CategoriesPage = () => {
    ...
    const [columnsPerRow, setColumnsPerRow] = useState(() => {
        ...
        if (window.innerHeight < 650 || /Android|iPhone|iPod/i.test(navigator.userAgent)) return 4;
    ...
    useEffect(() => {
        const updateColumnsPerRow = () => {
            if (window.innerHeight < 650 || /Android|iPhone|iPod/i.test(navigator.userAgent)) setColumnsPerRow(4);
            else if (window.innerWidth >= 1024) setColumnsPerRow(8);

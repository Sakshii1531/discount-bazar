...
import SellerConflictDialog from '../shared/SellerConflictDialog';
...
const CustomerLayout = ({ children, showHeader: showHeaderProp, fullHeight = false, showCart: showCartProp, showBottomNav: showBottomNavProp }) => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
            ...
            <main className={cn("flex-1 md:pb-0", !showHeader && "pt-0", finalShowBottomNavMobile ? "pb-32 md:pb-0" : (!fullHeight && "pb-16"))}>
                {children}
            </main>

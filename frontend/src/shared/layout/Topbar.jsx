...
const Topbar = ({ onMenuClick }) => {
    ...
    const handleLogoutClick = () => {
        if (role === 'admin' || role === 'seller' || isSeller) {
    ...
    return (
        <header className={cn(
            ...
            <ConfirmDialog
                ...
                title="Sign Out"
                message={isSeller || role === 'seller'
                    ? "Are you sure you want to sign out from the seller panel?"
                    : "Are you sure you want to sign out from the admin center?"}

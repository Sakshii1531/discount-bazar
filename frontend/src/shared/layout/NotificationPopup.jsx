                                    ...
                                    <div className="flex gap-4">
                                        <div className={cn(
                                            ...
                                            notif.type === 'order' ? "bg-brand-50 text-brand-600" :
                                                (notif.type === 'payment' || notif.type === 'WITHDRAWAL_REQUESTED') ? "bg-amber-50 text-amber-600" :
                                                    "bg-brand-50 text-brand-600"
                                        )}>
                                            {notif.type === 'order' ? <HiOutlineCheckCircle size={20} /> :
                                                (notif.type === 'payment' || notif.type === 'WITHDRAWAL_REQUESTED') ? <HiOutlineClock size={20} /> :

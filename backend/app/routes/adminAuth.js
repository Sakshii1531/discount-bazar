...
router.get("/pending-review-counts", verifyToken, allowRoles("admin"), getPendingReviewCounts);
...
router.post("/bulk-settle-cash", verifyToken, allowRoles("admin"), bulkSettleCash);
router.post("/delivery-cash/:id/remind", verifyToken, allowRoles("admin"), sendRiderCashReminder);

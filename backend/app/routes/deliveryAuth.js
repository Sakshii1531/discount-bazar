...
import {
  ...
  checkDeliveryApplicationStatus,
...
router.get("/application-status", optionalVerifyToken, checkDeliveryApplicationStatus);
...
router.get("/withdrawals", verifyToken, getDeliveryWithdrawals);
